...
fun main() = application {
    ...
    val processManager = remember {
        ...
        ProcessManager(scope).also { it.start("/Users/oniichan/.local/bin/claude", "--output-format", "stream-json",
            "--verbose", "--input-format", "stream-json", "--max-thinking-tokens", "31999", "--model", "default",
